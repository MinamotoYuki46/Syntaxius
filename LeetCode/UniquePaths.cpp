...
// Approach:
// using DP. First initialize 2D array m * n with default value 1 for all element. then for 1 to n -1 or m - 1, calculate by adding upper and left cell value
...
int main() {
    Solution sol;
    // Example test case
    int result = sol.uniquePaths(3, 7);
